...
const verfiyPassword = async (plainPassword, Hashpassword) => {
    try {
        const PasswordVerify = await bcrypt.compare(plainPassword, Hashpassword);
...
module.exports = { generateHashPassword, verfiyPassword, Protect,verification_code };
